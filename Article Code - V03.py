# -*- coding: utf-8 -*-
"""Article-CODE-V03.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1AWk00xQALXcTWrYlg_f33hsQOAaPUGS7
"""
...
def simulate_cycle_traces_full(A, Th, tau, P=ASSUMPTIONS, Pphys=PHYS):
    ...
    for i in range(N_half):
        ...
        Qdes_arr.append(0.0)          # no desorption heat during adsorption
        w_arr.append(w_new)
    ...
    for j in range(N_half, N):
        ...
        t_arr.append(j * dt)
        mdot_arr.append(mdot)
        Qe_arr.append(0.0)             # no cooling during desorption
