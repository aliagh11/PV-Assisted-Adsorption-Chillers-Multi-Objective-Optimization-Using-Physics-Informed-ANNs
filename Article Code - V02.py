...
ASSUMPTIONS = {
    ...
    "L_cool_req": 5000.0, # W required cooling load (5 kW)
...
def simulate_cycle_ldf(A, Th, tau, P=ASSUMPTIONS, Pphys=PHYS):
    ...
    Qe_avg   = Pphys.get("N_beds",2) * Qe_avg_per_bed
    Qads_avg = Pphys.get("N_beds",2) * Qads_avg_per_bed
    Qh_eff   = Pphys.get("N_beds",2) * Qh_eff_per_bed
...
cb          = LogCallback()  # ADDED

res = minimize(problem, algorithm, termination, verbose=True, seed=42, callback=cb)
